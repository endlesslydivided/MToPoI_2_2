package by.kovalev.command.authorithation.contants;
...
public class AuthConstants {
    ...
    public final static String REGISTER_ERROR_MESSAGE_IF_EXIST ="Выберите другое имя, такой пользователь существет";
